...
*/
extern void GUI_Dot(unsigned short x, unsigned short y, unsigned short color);
...
*   that no check on the parameters needs to be performed.
*/
extern unsigned short GUI_ReadDot(unsigned short x, unsigned short y);
...
*       _FillRect
*/
void GUI_Box(unsigned short xState, unsigned short yState, unsigned short xEnd, unsigned short yEnd, unsigned short color);
static void _FillRect(GUI_DEVICE *pDevice, int x0, int y0, int x1, int y1)
{
	...
	{
		GUI_Box(x0, y0, x1, y1, PixelIndex);
//		for (; y0 <= y1; y0++)
//		{
//			for (x = x0; x <= x1; x++)
//			{
